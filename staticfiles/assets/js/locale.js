...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const languageSelector = document.getElementById("languageSelector1");
  const currentLang = document.getElementById("currentLang1");
  const currentLangText = document.getElementById("currentLangText1");
  const dropdown = document.getElementById("dropdown1");
  const langOptions = document.querySelectorAll(".lang-option1");
  ...
  function setActiveLanguageButton() {
    ...
    const activeOption = document.querySelector(
      `.lang-option1[data-lang="${currentLang}"]`
    );
    if (activeOption) {
      activeOption.classList.add("active");
    }
  ...
  function updateNavLinks() {
    const savedLang =
      localStorage.getItem("selected_language") || getCurrentLanguage();
    const navLinks = document.querySelectorAll(
      ".navbar-nav .nav-link:not(.lang-option1)"
    );
